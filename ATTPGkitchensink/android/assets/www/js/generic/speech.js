...
var ATT = {
	...
	speech : function(path, context, language, cbData) {
		...
		var xargPlatform = "ClientApp=ATTPgKitchenSink,ClientVersion=2.5.0,ClientScreen=Browser,ClientSdk=PhoneGap,DeviceType=SmartPhone,DeviceOs=Android,";
		if(context == 'TV'){
