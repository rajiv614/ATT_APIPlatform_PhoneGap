...
var CALL_ATT = {
    ...
    /**
	 * conference
	 * @param options.body JSON object containing parameters od number to message the data and feature used is broadcast
	 * @param options.contentType The message content that is passes from application to plugin
	 * @param options.accept Format in which data will be formatted on return
	 */
	 ...
	 * @param options.body JSON object containing parameters od number to message the data, messageText contains the content and feature used is broadcast
	 * @param options.contentType The message content that is passes from application to plugin
	 * @param options.cmcId The session Id received when a call is made to a particular mobile number
     * @param options.body The tells that the signal that is passes is exit to terminate the call.
	 */	
