...
var ATT = {
	...
	/*
	 * SEND MMS test = 'Address=' + number + '&' + 'Priority=High' +'&'+
	 * 'Subject=' + subject ; urlbody = encodeURI(test); Mandatory @param
	 * Attachments -Attachments - Mandatory Developer can pass either filepath
	 * or fileObject(base64 urlencoded string) after picking image form gallery.
	 * for accept = application/xml var mmsId = $(data).attr('id'); for accept
	 * =application/json var mmsId = JSON.parse(data).Id;
	 */
	...
	/*
	 * GET MMS DELIVERY STATUS @param id -mmsId received in sendMMS response -
	 * Mandatory
	 */
