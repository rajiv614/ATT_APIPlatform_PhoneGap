...
var ATT = {
	/*
	 * WAP PUSH 'body' :'<wapPushRequest><address>' + number + '</address></wapPushRequest>',
	 * var test = 'address=' + number; urlbody = encodeURI(test); @param Data -
	 * Data which user will push (in XML form) - Mandatory
	 */
